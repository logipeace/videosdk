...
class Transport extends EnhancedEventEmitter implements MonitoringObject {
  // Id.
  late String _id;
  ...
  Consumer? getConsumer(String id) => consumers[id];
  ...
  Future<void> close() async {
    ...
    // Close all Consumers.
    for (Consumer consumer in consumers.values) {
